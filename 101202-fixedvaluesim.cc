...
static bool InitVehicle(Ptr<Highway> highway, int& VID)
{
	...
	Simulator::Schedule(Seconds(20.9), &AddVehicle, highway, vehW3);


	Ptr<Vehicle> vehE1=CreateVehicle(highway, 2, -1);
	Simulator::Schedule(Seconds(0.4), &AddVehicle, highway, vehE1);

	Ptr<Vehicle> vehE2=CreateVehicle(highway, 2, -1);
	Simulator::Schedule(Seconds(20.9), &AddVehicle, highway, vehE2);

	Ptr<Vehicle> vehE3=CreateVehicle(highway, 2, -1);
	Simulator::Schedule(Seconds(21.23), &AddVehicle, highway, vehE3);

	Ptr<Vehicle> vehE4=CreateVehicle(highway, 2, -1);
	Simulator::Schedule(Seconds(29.23), &AddVehicle, highway, vehE4);
