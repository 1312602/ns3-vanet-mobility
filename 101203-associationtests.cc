...
//	cout << "LOG " << nowtime.ns3::Time::GetSeconds() << " R " <<  RSUdst->GetVehicleId() << ' ' <<  RSUdstPos << '\n';
	...
	Ptr<Vehicle> vehW1=CreateVehicle(highway, 1, 1);
		// get veh1 broadcasting packet 1 at x=60, t=2
		unsigned int pID=1;
		Simulator::Schedule(Seconds(15.0), &AddPacket, vehW1, pID);
    AddVehicle(highway,vehW1);

	Ptr<Vehicle> vehE1=CreateVehicle(highway, 2, -1);
	Simulator::Schedule(Seconds(0.1), &AddVehicle, highway, vehE1);

	Ptr<Vehicle> vehW2=CreateVehicle(highway, 1, 1);
	Simulator::Schedule(Seconds(11.5), &AddVehicle, highway, vehW2);

	Ptr<Vehicle> vehW3=CreateVehicle(highway, 1, 1);
	Simulator::Schedule(Seconds(23.0), &AddVehicle, highway, vehW3);
//
	Ptr<Vehicle> vehW4=CreateVehicle(highway, 1, 1);
	Simulator::Schedule(Seconds(34.0), &AddVehicle, highway, vehW4);
//
	Ptr<Vehicle> vehW5=CreateVehicle(highway, 1, 1);
	Simulator::Schedule(Seconds(46.0), &AddVehicle, highway, vehW5);
//
